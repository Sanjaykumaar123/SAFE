    ...
    >
      {loading ? (
        ...
        <View style={styles.content}>
          {icon}
          <Text style={[styles.label, size === 'sm' && styles.labelSm, variantTextStyles[variant]]} numberOfLines={1}>
            {label}
          </Text>
        </View>
      )}
...
const sizeStyles = StyleSheet.create({
  sm: { paddingVertical: spacing.xs + 2, minHeight: 36, paddingHorizontal: spacing.md },
  md: { paddingVertical: spacing.sm + 2 },
